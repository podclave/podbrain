...
Faithful port of brain.sh. Same subcommands, same hook contract, same hard-won
protections (recursion guard, detached capture + Sprite keep-alive, single-flight
flock, feedback-loop strip, prompt-hijack delimiting, same-session dedup, offset
gating, since-marker sweep).
