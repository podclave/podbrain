...
#
# The mapping below is the authoritative bundle list; it mirrors the table in
# client/README.md — keep the two in sync. Contents come straight from the repo,
# so this is always current with whatever you just pulled.
set -euo pipefail
